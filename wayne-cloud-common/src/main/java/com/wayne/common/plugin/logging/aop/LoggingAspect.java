package com.wayne.common.plugin.logging.aop;
...
import com.wayne.common.plugin.logging.async.LoggingFactory;
...
public class LoggingAspect {
     ...
     * 切 面 编 程
     * */
    @Pointcut("@annotation(com.wayne.common.plugin.logging.aop.annotation.Logging) || @within(com.wayne.common.plugin.logging.aop.annotation.Logging)")
     ...
     * 获 取 注 解
     * */
    public com.wayne.common.plugin.logging.aop.annotation.Logging getLogging(ProceedingJoinPoint point) {
        MethodSignature signature = (MethodSignature) point.getSignature();
        Class<? extends Object> targetClass = point.getTarget().getClass();
        com.wayne.common.plugin.logging.aop.annotation.Logging targetLogging = targetClass.getAnnotation(com.wayne.common.plugin.logging.aop.annotation.Logging.class);
        if ( targetLogging != null) {
            return targetLogging;
        } else {
            Method method = signature.getMethod();
            com.wayne.common.plugin.logging.aop.annotation.Logging logging = method.getAnnotation(com.wayne.common.plugin.logging.aop.annotation.Logging.class);
            return logging;
        }
    }
}
