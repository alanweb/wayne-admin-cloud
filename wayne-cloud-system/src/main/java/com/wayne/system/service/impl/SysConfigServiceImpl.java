...
import com.wayne.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl extends ServiceImpl<SysConfigMapper, SysConfig> implements ISysConfigService {
    ...
    public List<SysConfig> list(SysConfig param) {
        return sysConfigMapper.selectList(new QueryWrapper<>(param));
    }
    ...
    public PageInfo<SysConfig> page(SysConfig param, PageDomain pageDomain) {
        ...
        List<SysConfig> list = list(param);
    ...
    public Boolean batchRemove(String[] ids) {
        Integer result = sysConfigMapper.deleteBatchIds(Arrays.asList(ids));
        return result > 0;
    }
