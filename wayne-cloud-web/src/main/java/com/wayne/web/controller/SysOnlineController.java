...
import com.wayne.common.web.session.HttpSessionContext;
import com.wayne.common.web.session.HttpSessionContextHolder;
import com.wayne.web.domain.SysOnlineUser;
...
public class SysOnlineController extends BaseController {
    ...
    public ResultTable data(String username) {
        ...
        for (Object obj : allPrincipalsUser) {
            ...
            SysBaseUser objs = (SysBaseUser) obj;
    ...
    public ModelAndView main() {
        return jumpPage("com/wayne/system/user/online");
    }
