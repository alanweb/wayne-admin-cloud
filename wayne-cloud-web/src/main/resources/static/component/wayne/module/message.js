layui.define(['table', 'jquery', 'element'], function(exports) {
	...
	function createHtml(option) {
		...
		var notice = '<li class="layui-nav-item" lay-unselect="">' +
			...
			'<div class="layui-nav-child layui-tab wayne-notice" style="margin-top: 0px;;left: -200px;">';
		...
		$.each(option.data, function(i, item) {
			...
			$.each(item.children, function(i, note) {
				noticeContent += '<div class="wayne-notice-item" notice-form="' + note.senderName + '" notice-context="' + note.content +
