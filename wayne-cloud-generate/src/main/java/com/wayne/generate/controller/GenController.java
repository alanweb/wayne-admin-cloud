package com.wayne.generate.controller;
...
import com.wayne.common.web.domain.response.module.ResultSelect;
...
import com.wayne.generate.service.IGenTableColumnService;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"wayne.zip\"");
